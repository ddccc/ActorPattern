...
public class ActorMeta extends ActorBase {
	...
	while ( again ) {
	    ...
	    /*
	    if ( 0 < noChangeCnt ) {
		nextAction.wakeUp(); // jump start the stalled process
		addTrace("*********** WakeUp squareZeroCnt: " + squareZeroCnt + 
			 " noChangeCnt: " + noChangeCnt +
			 " workCnt: " + workCnt);
	    }
	    */
	    // addTrace("squareZeroCnt: " + squareZeroCnt + " noChangeCnt: " + noChangeCnt);
