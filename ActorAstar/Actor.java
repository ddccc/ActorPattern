// File: c:/ddc/Java/ActorAstarB/Actor.java
// (C) OntoOO/ Dennis de Champeaux
// Date: Sat Jun 01 14:19:12 2019

// package actorAstarB; // adjust
...
public class Actor extends ActorBase {
    ...
    */ 
    ...
    private State hasSuccessorsS = new State(); // has successors
    public State getHasSuccessorsS() { return hasSuccessorsS; }
    ...
    */
	...
	RunMonitor monitorFetchNode =
	    new RunMonitor(new MonitorFetchNode(this, hasSuccessorsS), 100000);
	fetchNodeS.addConsumer(monitorFetchNode);
	monitors.addElement(monitorFetchNode);

	RunMonitor monitorNextNode =
	    new RunMonitor(new MonitorNextNode(this, hasSuccessorsS), 100000);
	hasSuccessorsS.addConsumer(monitorNextNode);
	monitors.addElement(monitorNextNode);
