File: c:/ddc/Java/ActorAstar/aaReadMe.txt
...
This is an abstract implementation of the A*-algorithm.
The Node class needs to be customized minimally.
See Actor3A, Actor7A, Actor10A & Actor12 for examples.
See also: HowTo.txt
