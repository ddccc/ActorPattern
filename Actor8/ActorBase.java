// File: c:/ddc/Java/Actor8/ActorBase.java
...
public abstract class ActorBase implements Runnable {
    ...
    // Timer
    // private Timer timer = new Timer(true); // daemon thread
    ...
    // protected Parser parser = new Parser(true);  // true for tracing
 ...
 // --- alert trace
	...
	/* obsolete
	Formula trigger = alert.getTrigger();
