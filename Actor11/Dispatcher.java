// File: c:/ddc/Java/Actor11/Dispatcher.java
...
class Goal1 extends Dispatcher {
    private Actor myActor = null;
    private Atom myTrigger = null;
    public Goal1(Actor ac, Formula t) {
	super(ac, t);
	myActor = (Actor)actor;
	myTrigger = (Atom) trigger;
    }
    public void init() { priority = 15; }
...
class Goal2 extends Dispatcher {
    private Actor myActor = null;
    private Atom myTrigger = null;
    public Goal2(Actor ac, Formula t) {
	super(ac, t);
	myActor = (Actor)actor;
	myTrigger = (Atom) trigger;
    }
